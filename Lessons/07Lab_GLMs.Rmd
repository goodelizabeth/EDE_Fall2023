...
OzonebyAll.regression <- lm(data = EPAair.subset, PM2.5 ~ Ozone + Year + Month + mean_Lng + mean_Lat)
step(OzonebyAll.regression)

# the smaller the AIC the bette the regression model 

# the only variable that's a candidate for removal are those listed before <none> and in this case that's Year 
...
ozoneBest.regression <- lm(data = EPAair.subset)
