...
> Answer: 
It tells you where packages are beign loaded from and what versions of packages are being loaded.
...
> Answer: 
They get filled with "NA" terms in the dataframe. 
...
> Answer: 
In time series analyses it is important to retain NA values. However, when you have someone reading and reporting variables and say there are some missing variables in the beginning of an analysis before a certain variable was of interest of was being collected, it would be okay to remove those NA values to create a complete data set.
