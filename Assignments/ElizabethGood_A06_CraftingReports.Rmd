...
```{r project.setup, echo=TRUE, message=FALSE, warning=FALSE, results='hide'}
#Import libraries
...
```{r boxplot 2018, echo=FALSE, message=FALSE, warning=FALSE, fig.align='left', fig.height=4, fig.width=5.5, fig.cap="Monthly Ozone, 2018"}
...
print(ozone)
```
```{r boxplot 2019, echo=FALSE, message=FALSE, warning=FALSE, fig.align='left', fig.height=4, fig.width=5.5, fig.cap="Monthly Ozone, 2019"}
...
## Git Repository
<https://github.com/goodelizabeth/EDE_Fall2023/tree/main>
